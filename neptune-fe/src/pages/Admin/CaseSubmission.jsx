...
const caseData = {
  ...
  description:
    "Given an array of integers, perform a series of operations and return the resulting array. Each operation consists of adding a value to each element between two indices, inclusive.",
  class: "Class A",
};
      ...
      <div className="min-h-[80vh] flex flex-col items-center bg-gradient-to-br from-blue-100 via-blue-200 to-blue-300 px-2 py-8">
        <div className="bg-white/95 shadow-2xl rounded-2xl p-0 w-full max-w-2xl flex flex-col gap-0 border border-blue-100">
          ...
          <div className="px-8 pt-6 pb-2">
            ...
            <div className="mb-2 text-base text-gray-700 whitespace-pre-line">
